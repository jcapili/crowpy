...
class CrowPy(object):
    ...
    def __init__(self, usps_id = '070SHIPP8017'):
    ...
    def calculateCSVMiles(self, input_path, output_path, google = False, resetChunks = True):
        ...
        dataIterator = pd.read_csv(str('~/Downloads/aprilOrderData.csv'), chunksize=100)
        length = 0
        ...
        for chunk in dataIterator:
            ...
            chunkData = chunk[~chunk['shipZip'].str[:5].isin(self.APO_zips)]
